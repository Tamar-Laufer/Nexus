const { selectAll, selectById, insertRow, updateRow, insertRowAutoId, existsByFields, updateByField } = require('./baseQueries');

// המרת שורה שטוחה מהדאטהבייס לאובייקט מקונן
...
const createUser = async (user) => {
  ...
  return toUser(await insertRow('users',
